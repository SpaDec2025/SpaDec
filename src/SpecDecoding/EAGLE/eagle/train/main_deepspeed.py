...
config_path = "llama_2_7B_dllm_config.json"
parser = argparse.ArgumentParser(description='sp')
parser.add_argument('--basepath', type=str, default='models/Vicuna')
parser.add_argument('--tmpdir', type=str, default='datasets/eagle/Vicuna_alpaca_0_51999_mufp16')
parser.add_argument('--cpdir', type=str, default='models/eagle-head/Vicuna')
